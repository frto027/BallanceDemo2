...
public class FP_Ball : F_Player
{
    ...
    public override void Reset()
    {
        ...
        tempG.GetComponentInChildren<F_BirthBall>().GamePlayerToBeCreated = (Resources.Load("levels/FP_Ball_Wood_MF") as GameObject).GetComponent<FP_Ball>();
    ...
    public override void DestoryEffect()
    {
        ...
        Instantiate(WoodPiece, tf.position, tf.rotation);
    }
}
